<template>
  <div class="hello">
    <div class="boxed-page">
      <nav id="gtco-header-navbar" class="navbar navbar-expand-lg">
        <div class="container-fluid">
          <router-link class="navbar-brand d-flex align-items-center" style="display: flex; text-decoration: none;" to="/about">
            <span class="lnr">{{msg}}</span>
          </router-link>
        </div>
      </nav>
      <hr>
      <div class="jumbotron d-flex align-items-center grid-item-wrapper">
        <div class="container text-center">
          <h1 class="display-2 mb-4">Hello,</h1>
            <p>
              The destination of our journey is never a place, but a new way of seeing things.
            </p>
        </div>
      </div>
      ...
      <div class="footer-basic">
        <footer>
          <div class="social">
            <a href="#"><img src="../assets/instagram-square-brands.svg"></a>
            <a href="#"><img src="../assets/facebook-square-brands.svg"></a>
            <a href="#"><img src="../assets/linkedin-brands.svg"></a>
            <a href="#"><img src="../assets/twitter-square-brands.svg"></a>
          </div>
          ...
          <p class="copyright">Aerolinea 2022</p>
        </footer>
      </div>
    </div>
  </div>
...
<style scoped lang="scss">
  ...
  .hello {
    ...
    .hello:after {
      ...
      z-index: 1;
      background: #f12711;
      background: -webkit-linear-gradient(to right, #122A73, #BF6F41);
      background: linear-gradient(to right, #122A73, #BF6F41); }
  ...
  a:hover {
    ...
    color: #b9aea8cd;
    text-shadow: -7px -3px 8px rgba(108,88,140,0.75);
    transition: color .4s; }
  ...
  #gtco-header-navbar {
    position: sticky;
    background-color: rgba(104, 110, 54, 0.833);
    top: 0;
    right: 0;
    left: 0;
    z-index: 11;
  ...
  @media (max-width: 992px) {
    ...
    #gtco-header-navbar {
      padding-left: 15px;
      background-color: rgba(154, 162, 94, 0.529); }
